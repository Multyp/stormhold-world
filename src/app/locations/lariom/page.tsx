      ...
      <main className="min-h-[100dvh] min-w-[100dvw]">
        ...
        <section className="py-10 px-4">
          ...
          <div className="flex items-center justify-center flex-col">
            <p className="text-lg text-gray-600 mt-4 text-left max-w-screen-lg">
              Lariom, the human kingdom situated in the southwest of the
              continent, is known for its strategic military positions and rich
              cultural history.
            </p>
            <p className="text-lg text-gray-600 mt-4 text-left max-w-screen-lg">
              As part of the broader continent of STORMHOLD, Lariom plays a
              crucial role in both the political and economic spheres.
            </p>
